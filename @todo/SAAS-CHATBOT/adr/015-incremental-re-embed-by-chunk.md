...
a tenant (`PRICING/embeddings.md` §1.3).
...
The per-plan **reingestion budget = K × storage** (`PRICING/plans.md` §6.1 / §7.3), launched cautiously at
...
- Bounds worst-case cost exposure per tenant (`PRICING/plans.md` §7.3).
